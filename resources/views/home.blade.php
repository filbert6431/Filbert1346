...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="font-Filbert" >Welcome Aboard!</h1>
            <p class="font-Filbert">A simple and elegant app using Bootstrap 5 and Laravel Blade.</p>
     <img src ="{{ asset('asset/Images/apple.png') }}"alt ="logo">
            ...
            <div class="col-md-6">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class ="font-Filbert">Our application provides a clean and intuitive interface, allowing users to navigate easily and perform tasks efficiently. Built with Laravel and Bootstrap, it offers flexibility and responsiveness.</p>
